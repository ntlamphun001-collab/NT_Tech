...
const CLOUDINARY_CONFIG = {
    ...
    folder: 'nt-engineering/maeta(t)', // โฟลเดอร์ใน Cloudinary
    maxFiles: 10
};
...
// 1. ดึงชื่อไฟล์จาก URL อัตโนมัติ (เช่น "maeta.html" -> จะได้ "maeta")
 ...
 * ให้วางฟังก์ชันนี้ไว้ในไฟล์ maeta-scripts.js ด้วยครับ
 */
...
window.addEventListener('DOMContentLoaded', () => {
    loadEquipmentCounts();
    loadMaetaTData(); // ✅ แก้ชื่อฟังก์ชันให้ตรงกับที่เราเปลี่ยนในจุดที่ 2
    initToggleViewMore();
});
