...
const CLOUDINARY_CONFIG = {
    ...
    folder: 'nt-engineering/nikhom', // โฟลเดอร์ใน Cloudinary
    maxFiles: 10
};
...
// 1. ดึงชื่อไฟล์จาก URL อัตโนมัติ (เช่น "nikhom.html" -> จะได้ "nikhom")
...
function createImageItemHTML(image) {
    ...
    // 💡 NEW: ใช้ URL ที่ถูกตรวจสอบแล้ว (img.url คือ finalUrl จาก loadNikhomData)
...
window.addEventListener('DOMContentLoaded', () => {
    loadEquipmentCounts();
    loadNikhomData(); // ✅ แก้ชื่อฟังก์ชันให้ตรงกับที่เราเปลี่ยนในจุดที่ 2
    initToggleViewMore();
});
